...
!function (e) {
    ...
    function f() {
        me
            .add(ve + "new-1-1.jpg")
            .add(ve + "new-1-2.png")
            .add(ve + "new-1-3.png?t=1")
            .add(ve + "mask.png")
            .add(ve + "tree1.png")
            .add(ve + "tree2.png")
            .add(ve + "new-114-8-bgh.jpg")
            .add(ve + "tree.png")
            .add(ve + "wall.jpg?t=1")
            .add(ve + "new-2-1.jpg")
            .add(ve + "new-2-2.png")
            ...
            .add(ve + "new-3-3.png")
            .add(ve + "new-5-1.jpg")
            .add(ve + "new-114-wolf-bg.png")
            .add(ve + "new-5-3.png")
            .add(ve + "new-5-4.png")
            .add(ve + "6-1.png")
            .add(ve + "new-6-bag.png")
            .add(ve + "new-114-book.png")
            .add(ve + "new-6-smallbook.png")
            .add(ve + "new-7-1.jpg")
            .add(ve + "new-7-2.png")
            .add(ve + "new-7-3.png")
            .add(ve + "new-10-1.png")
            .add(ve + "new-114-moon-human.png")
            .add(ve + "new-10-3.png")
            .add(ve + "new-10-4.jpg")
            .add(pt).add(dt)
            .add(ve + "new-114-person1.png")
            .add(ve + "new-114-person2.png")
            .add(ve + "new-114-1-talk.png")
            .add(ve + "new-114-2-talk.png")
            .add(ve + "new-114-btn-fake.png")
            .add(ve + "b.jpg")
            .add(ve + "new-114-hand.png")
            .add(ve + "new-114-alpha.png")
            .add(ht)
            .add(Tt)
            .add(mt)
            .add(gt)
